...
public class GenerarPedido extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                ...
                PedidoDTO pedidoDTO = (PedidoDTO)request.getSession().getAttribute("pedido");
                PedidoDAO pedidoDAO = new PedidoDAO();
                pedidoDAO.create(pedidoDTO);

            request.getRequestDispatcher("ListadoPedidos").forward(request, response);
